...
const Table = React.forwardRef((_a, ref) => {
    ...
    return (_jsx("table", Object.assign({ ref: ref, className: cn("w-full caption-bottom text-sm", className) }, props)));
});
...
const TableRow = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx("tr", Object.assign({ ref: ref, className: cn("border-b transition-colors", className) }, props)));
});
