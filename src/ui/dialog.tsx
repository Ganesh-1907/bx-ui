...
const DialogHeader = ({
  ...
  <div
    className={cn("sticky top-0 mt-0 flex justify-center pb-2", className)}
    {...props}
  >
    {children}
  </div>
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "mb-1 flex flex-col-reverse justify-center sm:flex-row sm:space-x-2",
      className
    )}
    {...props}
  />
